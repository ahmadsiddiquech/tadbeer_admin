...
<div class="row">
    ...
    <div class="col-md-6">
        <h4 ><b>Image:&nbsp;&nbsp;</b></h4><image src="<?php if(isset($user['image']) && !empty($user['image'])) { echo BASE_URL.SMALL_NEWS_IMAGE_PATH. $user['image']; } else{ echo "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";} ?>">
    </div>
</div>