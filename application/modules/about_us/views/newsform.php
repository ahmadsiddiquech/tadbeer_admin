  ...
  <div class="page-content"> 
    <div class="content-wrapper">
      ...
      <h3>
        <?php 
        if (empty($update_id)) 
                    $strTitle = 'Add About us';
                else 
                    $strTitle = 'Edit About us';
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL . 'about_us'; ?>"><button type="button" class="btn btn-primary btn-lg pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;<b>Back</b></button></a>
       </h3>             
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'about_us/submit/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'about_us/submit/' . $update_id, $attributes);
                        ?>
                  <div class="form-body">
                                        ...
                                        <div class="col-md-8">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                    ...
                                                    ?>
                                                    <img src = "<?php echo base_url() . 'uploads/about_us/medium_images/' . $news['image'] ?>" />
                                                    <?php
                                                } else {
                                                    ?>
                    ...
                    <div class="col-md-6">
                      <div class="col-md-offset-2 col-md-9" style="padding-bottom:15px;">
                       <span style="margin-left:40px"></span> <button type="submit" id="button1" class="btn btn-primary"><i class="fa fa-check"></i>&nbsp;Save</button>
                        <a href="<?php echo ADMIN_BASE_URL . 'about_us'; ?>">
