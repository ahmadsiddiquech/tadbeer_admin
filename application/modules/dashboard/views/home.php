...
<div class="row" style="padding-left:40px;padding-bottom: 30px;padding-top: 30px;">
    <div class="col-md-3" onclick="location.href='services';">
        <div class="card text-white col-md-12 shadow" style="background-color: rgb(255, 189, 53); border-radius: 5px;">
            <div class="card-body ">
                <h3 class="card-text"><center>Total <br>Services<br><?php echo $service; ?></center></h3>
            </div>
        </div>
    </div>
    <div class="col-md-3" onclick="location.href='news';" >
        <div class="card text-white  col-md-12 shadow" style="background-color: rgb(2, 156, 252); border-radius: 5px;">
            <div class="card-body">
                <h3 class="card-text"><center>Total <br>News<br><?php echo $provider; ?></center></h3>
            </div>
        </div>
    </div>
    <div class="col-md-3" onclick="location.href='packages';">
        <div class="card text-white col-md-12 shadow" style="background-color: rgb(115, 96, 237); border-radius: 5px;">
            <div class="card-body">
                <h3 class="card-text"><center>Total <br>Packages<br><?php echo $package; ?></center></h3>
            </div>
        </div>
    </div>
