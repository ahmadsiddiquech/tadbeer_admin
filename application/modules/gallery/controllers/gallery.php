...
//Modules::run('site_security/has_permission');
    ...
    function manage() {
        $data['news'] = $this->_get('gallery.id desc');
        $data['view_file'] = 'news';
    ...
    function upload_image($nId) {
        ...
        if(isset($upload_image_file) && !empty($upload_image_file)){
            ...
            $file_name = 'gallery_' . $nId . $upload_image_file;
        }
        else{
            $file_name = '';
        }
    ...
    function _getItemById($id) {
        ...
        return $this->mdl_gallery->_getItemById($id);
    }
    ...
    function _update($arr_col,$data) {
        $this->load->model('mdl_gallery');
        $this->mdl_gallery->_update($arr_col, $data);
    }
    ...
    function _delete($arr_col) {       
        $this->load->model('mdl_gallery');
        $this->mdl_gallery->_delete($arr_col);
    }
}