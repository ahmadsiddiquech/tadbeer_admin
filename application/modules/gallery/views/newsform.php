  ...
  <div class="page-content"> 
    <div class="content-wrapper">
      ...
      <h3>
        <?php 
        if (empty($update_id)) 
                    $strTitle = 'Add Gallery';
                else 
                    $strTitle = 'Edit Gallery';
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL . 'gallery'; ?>"><button type="button" class="btn btn-primary btn-lg pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;<b>Back</b></button></a>
       </h3>             
